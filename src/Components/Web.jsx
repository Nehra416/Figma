...
import fourthImage from "./Images/4th.png"
        ...
        <div >
            ...
            <div className="rating">
                ...
                <div>
                    ...
                    <span>Satisfaction rate from our customers.</span>
                </div>
                <div>
            ...
            <div className="services">
                <div className="firstdiv">
                    ...
                    <p className='service2nd'>With lots of unique blocks, you can easily build a page without coding. Build your next landing page.</p>
                </div>
                ...
                <div className="seconddiv">
                    ...
                    <div className="s2">
                        <img src={secondImage} />
                        <p>Content Writing &rarr;</p>
                    </div>
                    <div className="s3">
                        <img src={thirdImage} />
                        <p>Graphic Design &rarr;</p>
                    </div>
                    <div className="s4">
                        <img src={fourthImage} />
            ...
            <div className="testimonal">
                ...
                <div className="t2">
                    <center><img src={google} alt="google" className='amazon' /></center>
                    <p className='testimonalP'>
                        “Must have book for students, who want to be a great Product Designer.”
                    </p>
                    <div className="t2inner">
                        <img src={t2} className='profile' />
                        <div>
                            <h1>Mariano Rasgado</h1>
                            <p>Software Engineer</p>
                        </div>
                    </div>
                </div>
                <div className="t3">
                    ...
                    <div className="t3inner">
                        <img src={t3} className='profile' />
                        <div>
                            <h1>Oka Tomoaki</h1>
                            <p>Software Engineer</p>
                        </div>
            ...
            <div className="form">
                ...
                <div className="formright">
                    <form action="">
                        ...
                        <input type="text" placeholder='i.e Nehra' />
                        <label htmlFor="">Email</label>
                        <input type="text" placeholder='i.e Nehra416@gmail.com' />
                        <label htmlFor="">Phone</label>
                        <input type="text" placeholder='i.e. 123-456-7890' />
                        <label htmlFor="">Which service do you need?</label>
            ...
            <div className="cta">
                <h1>Subscribe to our newsletter to get latest news on your inbox.</h1>
                <div>
